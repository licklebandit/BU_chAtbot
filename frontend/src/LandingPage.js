...
const featureCards = [
  {
    ...
    description: "Navigate entry requirements, deadlines, and application status with confidence.",
    icon: GraduationCap,
  },
  {
    title: "Program information",
    description: "Compare faculties, majors, and course offerings tailored to your goals.",
    icon: BookOpen,
  },
  {
    title: "Timetable & exam support",
    description: "Stay on top of academic calendars, exam schedules, and registration windows.",
    icon: CalendarDays,
  },
  {
    title: "Campus navigation",
    description: "Find lecture halls, offices, and student services wherever you are on campus.",
    icon: MapPin,
  },
  {
    title: "Fees & financial aid",
    description: "Understand tuition, payment plans, scholarships, and sponsorship requirements.",
    icon: Wallet,
  },
  {
    title: "Student support & wellbeing",
    description: "Connect with housing, counselling, and wellbeing resources in seconds.",
    icon: LifeBuoy,
  },
];
...
const metrics = [
  ...
  { label: "Knowledge articles", value: "450+" },
];
...
const howItWorks = [
  {
    step: "Ask a question",
    detail: "Type your admissions, academics, or campus question in natural language.",
  },
  {
    step: "AI understands your intent",
    detail: "Our assistant interprets the request and consults Bugema-approved sources.",
  },
  {
    step: "Get accurate answers",
    detail: "Receive a clear, university-approved response or a guided handoff to staff.",
  },
];
...
const testimonials = [
  ...
  {
    quote: "Trusted by thousands of learners every intake — onboarding has never been smoother.",
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "The assistant references institutional policies, program guides, and FAQs approved by university departments.",
  },
  {
...
function LandingPage() {
  ...
  const cardShadow = isDark ? "shadow-lg shadow-slate-900/50" : "shadow-lg shadow-[#0033A0]/10";
  ...
  return (
    <div className={`relative min-h-screen overflow-hidden transition-colors duration-500 ${themeClasses}`}>
      ...
      <header className={headerClasses}>
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
          <div className="flex items-center gap-3">
            ...
            />
            <p className={`text-lg font-semibold ${isDark ? "text-slate-100" : "text-[#102863]"}`}>BUchatbot</p>
          </div>
          <nav className="hidden items-center gap-6 text-sm font-medium md:flex lg:gap-10">
            ...
            <a className={navLinkClass} href="#security">
              Security
            </a>
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={toggleTheme}
              className={`flex items-center gap-2 rounded-full border px-3 py-2 text-xs font-semibold backdrop-blur transition md:text-sm ${isDark ? "border-slate-700 bg-slate-900/70 text-slate-200 hover:bg-slate-900" : "border-white/60 bg-white/70 text-[#0033A0] hover:bg-white"}`}
            >
              {isDark ? (
                <>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-full bg-[#0033A0] px-5 py-2 text-sm font-semibold text-white shadow-lg shadow-[#0033A0]/30 transition hover:bg-[#062a7a]"
            >
              Get started
      ...
      <main className="relative z-10">
        <section className="mx-auto flex max-w-6xl flex-col gap-14 px-6 pb-16 pt-20 lg:flex-row lg:items-center">
          <div className="max-w-2xl space-y-7">
            ...
            >
              Get instant answers about admissions, registration, fees, housing, and campus services—all sourced from Bugema University's verified knowledge so you never miss a deadline or update.
            </motion.p>
            ...
            <div className="grid gap-2 sm:grid-cols-3" id="outcomes">
              {metrics.map((metric) => (
                <div
                  key={metric.label}
                  className={`rounded-2xl border ${isDark ? "border-slate-800 bg-slate-900/60" : "border-[#d7e1ff] bg-white/80"} px-4 py-3 shadow-sm`}
                >
                  <p className={`text-2xl font-semibold ${isDark ? "text-white" : "text-[#0b2254]"}`}>
                    {metric.value}
                  </p>
                  <p className={`text-sm ${isDark ? "text-slate-400" : "text-[#4f5e92]"}`}>{metric.label}</p>
                </div>
              ))}
            </div>
            <div className={`rounded-3xl border p-6 shadow-lg shadow-[#0033A0]/10 ${isDark ? "border-slate-800 bg-slate-900/70" : "border-[#becdff] bg-white/90"}`}>
              <p className={`text-xs uppercase tracking-[0.25em] ${isDark ? "text-slate-300" : "text-[#4a5aa6]"}`}>Popular topics</p>
              <div className="mt-3 grid gap-2 sm:grid-cols-2">
                {quickTopics.map((topic) => (
                  <button
                    key={topic}
                    onClick={() => navigate("/chatbot", { state: { prompt: topic } })}
          ...
          >
            <div className={`w-full max-w-lg rounded-3xl border p-6 shadow-xl ${isDark ? "border-slate-800 bg-slate-900/80" : "border-slate-200 bg-white"}`}>
              <div className="mb-6 flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  <div className={`flex h-11 w-11 items-center justify-center rounded-2xl text-sm font-semibold ${isDark ? "bg-slate-800 text-slate-200" : "bg-[#0033A0]/10 text-[#0033A0]"}`}>
                    BU
                  </div>
                  <div>
                    <p className={`text-xs uppercase tracking-[0.3em] ${isDark ? "text-slate-400" : "text-[#4a5aa6]"}`}>
                      BUchatbot
                    </p>
                    <p className={`text-sm font-medium ${isDark ? "text-slate-100" : "text-[#0b2254]"}`}>
                      Here to help 24/7
                    </p>
                  </div>
                </div>
              ...
              <div>
                ...
                <p className={`mt-2 text-lg font-semibold ${headlineColor}`}>Chat transcript</p>
              </div>
              <div className="mt-6 space-y-4 text-sm text-slate-600">
                ...
                <div className={`rounded-2xl p-4 ${isDark ? "bg-slate-800" : "bg-slate-900 text-white"}`}>
                  <p className={`text-xs uppercase tracking-[0.3em] ${isDark ? "text-slate-300" : "text-white/60"}`}>
                    Admin insight
                  </p>
                  <p className="mt-2 text-sm">
                    This response was approved by Student Affairs on Oct 18 and is tracked for follow-up.
                  </p>
                </div>
              </div>
            </div>
        ...
        >
          <div className="mx-auto max-w-6xl px-6">
            <div className="flex flex-col gap-4 text-center">
              ...
              <h2 className={`text-3xl font-semibold sm:text-4xl ${headlineColor}`}>
                Everything students ask about most
              </h2>
              <p className={`mx-auto max-w-2xl text-base ${bodyColor}`}>
                From admissions and academics to wellbeing and campus logistics, every topic is grounded in accurate university knowledge for confident decision-making.
              </p>
            </div>
            <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {featureCards.map(({ title, description, icon: Icon }) => (
                ...
                >
                  <div className={`flex h-12 w-12 items-center justify-center rounded-xl ${isDark ? "bg-[#0033A0]/30 text-[#9db8ff]" : "bg-[#0033A0] text-white"}`}>
                    <Icon className="h-5 w-5" />
                  </div>
                  <h3 className={`text-lg font-semibold ${headlineColor}`}>{title}</h3>
                  <p className={`text-sm leading-6 ${bodyColor}`}>{description}</p>
                </motion.article>
              ))}
            </div>
          </div>
        ...
        <section id="value" className="mx-auto max-w-6xl px-6 py-16">
          <div className={`rounded-3xl border p-8 shadow-2xl backdrop-blur ${isDark ? "border-slate-800 bg-slate-900/70" : "border-[#becdff] bg-white/95 shadow-[#0033A0]/10"}`}>
            <motion.div
            ...
            >
              <div className="text-center space-y-4">
                ...
                <p className={`mx-auto max-w-2xl text-base ${bodyColor}`}>
                  Students receive immediate clarity, while staff gain time to focus on the high-touch conversations that matter most.
                </p>
              </div>
              <div className="grid gap-3 sm:grid-cols-2">
                {valueHighlights.map((item) => (
                  ...
                  >
                    <CheckCircle className={`mt-1 h-4 w-4 ${isDark ? "text-[#97b5ff]" : "text-[#0033A0]"}`} />
            ...
            <div className="flex flex-col gap-6 text-center">
              ...
              <div className="grid gap-6 md:grid-cols-3">
                {howItWorks.map(({ step, detail }, index) => (
                  ...
                  >
                    <span className={`inline-flex h-8 w-8 items-center justify-center rounded-full text-sm font-semibold ${isDark ? "bg-[#0033A0]/30 text-[#a5befc]" : "bg-[#0033A0]/10 text-[#0033A0]"}`}>
                      {index + 1}
                    </span>
                    <h3 className={`text-base font-semibold ${headlineColor}`}>{step}</h3>
        ...
        <section id="security" className="mx-auto max-w-6xl px-6 py-16">
          <div className="grid gap-6 lg:grid-cols-[1.2fr_1fr]">
            <div className={`rounded-3xl border p-8 shadow-lg ${isDark ? "border-slate-800 bg-slate-900/70" : "border-[#d6dfff] bg-white"}`}>
              <h3 className={`text-lg font-semibold ${headlineColor}`}>Security, privacy & reliability</h3>
              <p className={`mt-2 text-sm leading-6 ${bodyColor}`}>
                Built with university compliance in mind. Every interaction follows Bugema University's governance for data protection and information accuracy.
              </p>
              <div className="mt-4 space-y-3">
                {securityHighlights.map((item) => (
                  <div key={item} className="flex items-start gap-3">
                    <Lock className={`mt-1 h-4 w-4 ${isDark ? "text-[#98b4ff]" : "text-[#0033A0]"}`} />
                    <p className={`text-sm ${bodyColor}`}>{item}</p>
                  </div>
                ))}
              </div>
            ...
            <div className={`rounded-3xl border p-8 shadow-lg ${isDark ? "border-slate-800 bg-slate-900/70" : "border-[#d6dfff] bg-white"}`}>
              <h3 className={`text-lg font-semibold ${headlineColor}`}>Need human help?</h3>
              <p className={`mt-3 text-sm leading-6 ${bodyColor}`}>
                The Student Support Desk is available if you need more personal assistance.
              </p>
              <div className="mt-4 space-y-1 text-sm">
                <p className={`${headlineColor}`}>Email: <span className="font-semibold">support@bugema.ac.ug</span></p>
                <p className={`${headlineColor}`}>Phone: <span className="font-semibold">+256 123 456 789</span></p>
            ...
            <div className="flex flex-col gap-6 text-center">
              ...
              {testimonials.map((item) => (
                <blockquote key={item.author} className="space-y-6">
                  <p className={`text-2xl font-semibold leading-relaxed ${headlineColor}`}>
                    “{item.quote}”
                  </p>
        ...
        <section id="faq" className="mx-auto max-w-5xl px-6 pb-16">
          <div className={`rounded-3xl border p-8 shadow-lg ${isDark ? "border-slate-800 bg-slate-900/70" : "border-[#d6dfff] bg-white"}`}>
            <div className="space-y-4">
              <p className={`text-xs uppercase tracking-[0.3em] ${isDark ? "text-slate-400" : "text-[#4a5aa6]"}`}>FAQ</p>
              <h2 className={`text-3xl font-semibold ${headlineColor}`}>Answers to common questions</h2>
            </div>
            <div className="mt-6 space-y-4">
              {faqs.map(({ question, answer }) => (
                ...
                >
                  <summary className={`flex cursor-pointer items-center justify-between text-sm font-semibold ${headlineColor}`}>
                    {question}
                    <span className="text-xs font-normal text-slate-400 group-open:hidden">+</span>
                    <span className="hidden text-xs font-normal text-slate-400 group-open:inline">−</span>
                  </summary>
                  <p className={`mt-3 text-sm leading-6 ${bodyColor}`}>{answer}</p>
                </details>
              ))}
            </div>
          </div>
        ...
        <footer className={`border-t px-6 py-10 ${isDark ? "border-slate-800 bg-slate-950/70" : "border-white/60 bg-white/95"}`}>
          <div className="mx-auto flex max-w-6xl flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="space-y-1">
                <p className={`text-lg font-semibold ${headlineColor}`}>BUchatbot</p>
                <p className={`text-xs ${mutedColor}`}>Conversational support for every student journey.</p>
              </div>
            </div>
            <div className="space-y-2 text-sm text-center md:text-right">
              <p className={`${mutedColor}`}>Need help? Email <a href="mailto:support@bugema.ac.ug" className={`font-semibold ${isDark ? "text-slate-200" : "text-[#102863]"}`}>support@bugema.ac.ug</a></p>
              <div className="flex flex-wrap items-center justify-center gap-4 md:justify-end">
                <a href="/privacy" className={`text-sm font-semibold transition ${isDark ? "text-[#9db8ff] hover:text-white" : "text-[#0033A0] hover:text-[#062a7a]"}`}>
                  Privacy policy
                </a>
                <a href="/chatbot" className={`text-sm font-semibold transition ${isDark ? "text-[#9db8ff] hover:text-white" : "text-[#0033A0] hover:text-[#062a7a]"}`}>
                  Launch assistant
                </a>
              </div>
              <p className={`text-xs ${mutedColor}`}>© {new Date().getFullYear()} BUchatbot. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </main>
